    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="right-side-nav-wrapper flex items-center lg:order-2">
                ...
                {{-- <button id="theme-toggle" class="btn dark:hover:bg-gray-700 dark:bg-gray-500 dark:text-white border-grey border-2 bg-white text-black hover:bg-gray-500 hover:text-white p-2 rounded cursor-pointer" type="button">Dark</button> --}}

                <label class="hidden lg:inline-flex lg:items-center cursor-pointer">
