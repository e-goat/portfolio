    ...
    <article>
        <div class="space-y-4 max-xl flex flex-col justify-between">
            <div class="flex flex-col gap-4">
                ...
                <h1 class="underline mb-4 text-4xl font-extrabold text-center leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">{{ $post->title }}</h1>
                <!-- <h1 class="text-2xl text-center underline">{{ $post->title }}</h1> -->
            </div>
            ...
            <div class="font-medium d-flex justify-between align-content-center">
                <div class="flex items-center gap-4 w-full ">
                    ...
                    <div class="font-medium">
                        ...
                        <div class="text-sm text-gray-500">Posted at {{$post->created_at}}</div>
                    </div>
                </div>
            </div>
            <blockquote>
