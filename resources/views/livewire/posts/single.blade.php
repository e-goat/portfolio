    ...
    <article>
        <div class="space-y-4 max-xl flex flex-col justify-between">
            <div class="flex flex-col gap-4">
                <a href="{{ route('home') }}" class="text-sky-500 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 p-3 w-max" wire:navigate>
